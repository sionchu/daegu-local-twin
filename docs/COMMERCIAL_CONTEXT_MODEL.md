...
- 한국부동산원 공동주택 2026-08-31 원문에서 대구 9,100개 단지·749,768세대의 구·군 주거용량 집계 반영
  - 법정동명과 SGIS 행정동명이 정확히 일치한 38개 동만 부분 세대수 증거로 연결
  - 동 단위 부분연결은 커버리지 32.84%이므로 상권잠재·주거생활권 최종점수에는 아직 미사용
- 전국주차장정보표준데이터에서 대구 1,086개 주차장·50,687면·공식 위경도 100% 확보
  - 실시간 빈자리 데이터가 아니라 공급용량/접근성 근거로만 사용
- KOSIS 전국사업체조사 2024 읍면동 총괄에서 대구 150개 행정동의 사업체·종사자 공식값 100% 코드매칭
  - 대구 전체 286,841개 사업체·1,021,246명 종사자이며 동→구군→시 합계가 정확히 일치
  - 전역 지도에 `직장종사자` 공식 상대강도 레이어와 행정동별 종사자·사업체·150개 동 순위를 제공
  - 사업체 소재지 기준 종사자수이므로 거주지 취업자·통근유입·시간대별 체류인구와 구분
- 행정안전부 2026-08-31 행정동 주민등록인구에서 SGIS 150개 권역을 100% exact-name 연결
  - 150개 권역 합산 2,346,277명, 전월 대비 -1,112명
  - 전역 지도에 `거주인구` 공식 상대강도 레이어와 인구·남녀·월증감·150개 권역 순위를 제공
  - 논공읍공단출장소·다사읍서재출장소 2개 행은 명시적으로 각 부모 읍에 합산
  - 주민등록인구는 생활인구·방문인구·시간대별 체류인구와 구분
...
P1 — 아직 필요한 데이터
- 통신 기반 생활인구·방문인구 및 행정동보다 세밀한 격자 인구
- 출퇴근/목적 OD
- 행정동보다 세밀한 격자·시간대별 직장 체류 신호
