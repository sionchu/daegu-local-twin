    ...
    <aside className="evidence-panel">
      ...
      {cell && scores ? <>
        ...
        <div className="evidence-section"><div className="section-title"><span>수요 분해</span><small>DemandScore</small></div>
          <FieldBar label="관련 이동수요 proxy" value={scores.footfall} note={`${formatNumber(cell.observedFootfall)}명/일 · ${cell.footfallSource ?? "출처 미상"}`} />
